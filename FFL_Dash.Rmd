...
# Establish current week as a variable to be used throughout the script
...
FFL_Table %>%
  ...
  geom_hline(yintercept = sum(FFL_Table$`Points For`)/(12*parse_number(current_wk)),
             color = "#5f6161", size = 1) +
...
hi_lite %>%
  plot_ly(x = ~Date, y = ~Position, color = ~Team, mode = "lines") %>%
